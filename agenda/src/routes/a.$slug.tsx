...
import { BookingSteps, type Etapa } from "@/components/booking-steps";
...
import { completo, diaPorExtenso, fusoDoNavegador, siglaDoFuso } from "@/lib/formato";
import { formatarDuracao, formatarPreco, type DadosDoCliente } from "@/lib/validation";
